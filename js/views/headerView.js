    ...
    renderStorage(listChats, onDeleteChat) {
        ...
        listChats.forEach((chat) => {
            ...
            li.innerHTML = `
                ...
                <div class="storage__item-remove">
                    <svg class="storage__item-remove-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24.000000" height="24.000000" fill="none">
