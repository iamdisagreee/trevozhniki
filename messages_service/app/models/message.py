...
class Chat(BaseSchema):
    ...
    # file_state: Mapped['FileState'] = relationship(back_populates='chat')


class FileState(BaseSchema):
    ...
    last_loaded_id: Mapped[int] = mapped_column(
        Integer,
    ...
    # )
    #
    # chat: Mapped['Chat'] = relationship(back_populates='file_state')
